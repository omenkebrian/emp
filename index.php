...
<html lang="en">
    <head>
        ...
        <!-- Title -->
        <title>Zu Leave System  | Home Page</title>
        ...
        <div class="mn-content fixed-sidebar">
                ...
                <nav class="cyan darken-1">
                    <div class="nav-wrapper row">
                        ...
                        <div class="header-title col s3">      
                            <span class="chapter-title">ZETECH Staff Leave System</span>
                        </div>
            ...
            <aside id="slide-out" class="side-nav white fixed">
                ...
                <ul class="sidebar-menu collapsible collapsible-accordion" data-collapsible="accordion" style="">
                    ...
                    <li class="no-padding"><a class="waves-effect waves-grey" href="forgot-password.php"><i class="material-icons"></i> Reset password</a></li>
                
                       <li class="no-padding"><a class="waves-effect waves-grey" href="admin/"><i class="material-icons"></i>Admin Login</a></li>
                
                </ul>
          <div class="footer">
                    <p class="copyright"><a href="http://www.zetech.ac.ke/">Zetech </a>©</p>
            ...
            <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title"><h4>Zetech  University Staff  Leave  Management System </h4></div>

...
$query->bindParam(':county',$city,PDO::PARAM_STR);
...
<input id="city" name="county" type="text"  value="<?php echo htmlentities($result->County);?>" autocomplete="off" required>
 </div>
